  ...
  slice: {
    container: css`
      ...
      &[active="true"] {
        cursor: auto;
        background: ${({ centerRadius }: any) =>
          `radial-gradient(transparent ${centerRadius}, #e16162 ${centerRadius})`};
        color: #001e1d;
        path {
          fill: #fffffe;
        }
...
export default function NoteInsertMenu({
  ...
  pos: [number, number];
  onClose: () => void;
  onAddNote: (duration: [number, number], modifier: number) => void;
  pitchModifier: number | null;
}) {
    ...
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        >
          ...
          <Slice
            onSelect={(ev: React.MouseEvent) => {
              ev.stopPropagation();
              setDots(1);
            }}
            attrs={{ active: dots === 1 ? "true" : undefined }}
          >
            {/* Aug dot */}
            <svg width="9mm" height="9mm" viewBox="0 0 9 9">
              <g transform="translate(0,-288)">
          ...
          <Slice
            ...
            attrs={{ active: accidental === 1 ? "true" : undefined }}
          >
            {/* Sharp */}
            <svg width="9mm" height="9mm" viewBox="0 0 9 9">
              <g transform="translate(0,-288)">
          ...
          <Slice
            ...
            attrs={{ active: accidental === 0 ? "true" : undefined }}
          >
            {/* Natural */}
            <svg width="9mm" height="9mm" viewBox="0 0 9 9">
              <g transform="translate(0,-288)">
